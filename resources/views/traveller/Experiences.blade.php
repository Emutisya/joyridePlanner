    ...
    <div class="row">
      ...
      <div class="text-center">
    	...
    	<div class="col-sm-9">
            ...
            <li><a data-toggle="tab" href="/profile">User Information</a></li>
              
               
                <li><a data-toggle="tab" href="/moreD">More Details </a></li>
                <li class="active"><a data-toggle="tab" href="/experiences">Share Experiences</a></li>
              </ul>
